...
export default function EditMembershipPlan({ plan }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        max_classes_per_week: plan.max_classes_per_week?.toString() || '',
        max_classes_per_month: plan.max_classes_per_month?.toString() || '',
        includes_nutrition_plan: plan.includes_nutrition_plan,
        includes_personal_training: plan.includes_personal_training,
        personal_training_sessions: plan.personal_training_sessions.toString(),
        ...
        <>
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold">Editar Plan de Membresía</h1>
...
EditMembershipPlan.layout = (page: React.ReactElement) => <AppLayout children={page} />;
